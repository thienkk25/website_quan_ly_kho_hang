...
$result = mysqli_query($conn, $sql); //hiển thị kết quả truy vấn
...
<div class="container">
        ...
        <main class="main-content">
            ...
            <h2>Danh sách sản phẩm</h2>
                <form method="GET" action=""> <!-- gửi dữ liệu lên URL dưới dạng time số, có thể bookmark lên chính trang hiện tại  -->
            ...
            <table>
                ...
                <?php while($row = mysqli_fetch_assoc($result)):    ?>  <!-- vòng lặp lấy từng dòng dữ liệu dưới dạng mảng kết hợp thành list -->
                    <tr>
