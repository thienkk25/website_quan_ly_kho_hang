    ...
    <div class="container">
        ...
        <h2><a style="text-decoration: none;color: white;display: block;" href="http://127.0.0.1/website_quan_ly_kho_hang/">TỔNG QUAN</a></h2>
            <ul>
                ...
                <li><a style="text-decoration: none;color: white;display: block;" href="components/warehouse_import.php">Nhập kho</a></li>
                <li><a style="text-decoration: none;color: white;display: block;" href="components/warehouse_export.php">Xuất kho</a></li>
